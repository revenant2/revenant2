(function(root, factory){
	 ...
	 * 
	 *  Modified and fixed for Revenant²
	 *  http://revenant2.github.io/
	 */
	Main(function () {
	        ...
	        if (difference !== null) {
				...
				if (this.loop) {
					var source = new Tone.BufferSource({
						...
						'loop': true,
						'loopStart': new Tone.Time(this.loopStart, "samples"),
						'loopEnd': new Tone.Time(this.loopEnd, "samples"),
						'fadeIn': this.attack,
	            ...
	            source.start(time, 0, new Tone.Time(100, "s"), velocity);
